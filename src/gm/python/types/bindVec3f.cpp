...
void BindVec3f( pybind11::module& o_module )
{
    ...
    cls.def_property( "x",
                      pybind11::cpp_function( []( Vec3f& i_vector ) -> float& { return i_vector.X(); },
                                              pybind11::return_value_policy::reference_internal ),
                      pybind11::cpp_function( []( Vec3f& o_vector, const float& i_x ) { o_vector.X() = i_x; } ),
                      "Named property getter / setter for the element at index 0." ); // Named Y element accessor.
    cls.def_property( "y",
                      pybind11::cpp_function( []( Vec3f& i_vector ) -> float& { return i_vector.Y(); },
                                              pybind11::return_value_policy::reference_internal ),
                      pybind11::cpp_function( []( Vec3f& o_vector, const float& i_y ) { o_vector.Y() = i_y; } ),
                      "Named property getter / setter for the element at index 1." ); // Named Z element accessor.
    cls.def_property( "z",
                      pybind11::cpp_function( []( Vec3f& i_vector ) -> float& { return i_vector.Z(); },
                                              pybind11::return_value_policy::reference_internal ),
                      pybind11::cpp_function( []( Vec3f& o_vector, const float& i_z ) { o_vector.Z() = i_z; } ),
