...
TEST_CASE( "Max_float" )
{
    float valueA = 1.333f;
    float valueB = 2.333f;
    CHECK( gm::Max( valueA, valueB ) == 2.333f );
}
...
TEST_CASE( "Max_bool" )
{
    bool valueA = true;
    bool valueB = true;
    CHECK( gm::Max( valueA, valueB ) == true );
}
...
TEST_CASE( "Max_Vec2f" )
{
    ...
    CHECK( gm::Max( valueA, valueB ) == gm::Vec2f( 0.0f, 2.333f ) );
}
...
TEST_CASE( "Max_Vec3f" )
{
    ...
    CHECK( gm::Max( valueA, valueB ) == gm::Vec3f( 0.0f, 2.333f, 4.666f ) );
}
...
TEST_CASE( "Max_Vec4f" )
{
    ...
    CHECK( gm::Max( valueA, valueB ) == gm::Vec4f( 0.0f, 2.333f, 4.666f, 6.999f ) );
}
...
TEST_CASE( "Max_Vec2i" )
{
    ...
    CHECK( gm::Max( valueA, valueB ) == gm::Vec2i( 0, 2 ) );
}
...
TEST_CASE( "Max_Vec3i" )
{
    ...
    CHECK( gm::Max( valueA, valueB ) == gm::Vec3i( 0, 2, 4 ) );
}
...
TEST_CASE( "Max_Vec4i" )
{
    ...
    CHECK( gm::Max( valueA, valueB ) == gm::Vec4i( 0, 2, 4, 6 ) );
}
...
TEST_CASE( "Max_Mat3f" )
{
    ...
    CHECK( gm::Max( valueA, valueB ) ==
           gm::Mat3f( 0.0f, 2.333f, 4.666f, 6.999f, 9.332f, 11.665f, 13.998f, 16.331f, 18.664f ) );
}
...
TEST_CASE( "Max_Mat4f" )
{
    ...
    gm::Mat4f valueB = gm::Mat4f( 0.0f,
                                  ...
                                  32.662f,
                                  34.995f );
    CHECK( gm::Max( valueA, valueB ) == gm::Mat4f( 0.0f,
                                                   2.333f,
                                                   4.666f,
                                                   6.999f,
                                                   9.332f,
