...
{
    {{ namespacedVectorClass }} {{ vectorType.varName }}A = {{ typeUtils.GenArithmeticSequence(vectorType, 1) }};
    {{ namespacedVectorClass }} {{ vectorType.varName }}B = {{ typeUtils.GenArithmeticSequence(vectorType, 5) }};
