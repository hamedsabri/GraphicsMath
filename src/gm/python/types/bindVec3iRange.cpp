...
void BindVec3iRange( pybind11::module& o_module )
{
    ...
    cls.def( "__repr__", []( const Vec3iRange& i_range ) { return pybind11::str( i_range.GetString( "gm." ) ); } );
    ...
    cls.def_property(
        "min",
        pybind11::cpp_function( []( Vec3iRange& i_range ) -> Vec3i& { return i_range.Min(); },
                                pybind11::return_value_policy::reference_internal ),
        pybind11::cpp_function( []( Vec3iRange& o_range, const Vec3i& i_min ) { o_range.Min() = i_min; } ),
