...
{
    gm::Mat3f matrix = gm::Mat3f( 0.0f, 2.0f, 4.0f, 6.0f, 8.0f, 10.0f, 12.0f, 14.0f, 16.0f );
    CHECK( matrix[ 0 ] == 0.0f );
    CHECK( matrix[ 1 ] == 2.0f );
    CHECK( matrix[ 2 ] == 4.0f );
    CHECK( matrix[ 3 ] == 6.0f );
...
{
    gm::Mat3f matrixA = gm::Mat3f( 0.0f, 2.0f, 4.0f, 6.0f, 8.0f, 10.0f, 12.0f, 14.0f, 16.0f );
    gm::Mat3f matrixB = gm::Mat3f( 0.0f, 5.0f, 10.0f, 15.0f, 20.0f, 25.0f, 30.0f, 35.0f, 40.0f );
...
{
    gm::Mat3f matrixA = gm::Mat3f( 0.0f, 7.0f, 14.0f, 21.0f, 28.0f, 35.0f, 42.0f, 49.0f, 56.0f );
    gm::Mat3f matrixB = gm::Mat3f( 0.0f, 5.0f, 10.0f, 15.0f, 20.0f, 25.0f, 30.0f, 35.0f, 40.0f );
    gm::Mat3f matrixC = matrixA - matrixB;
...
{
    gm::Mat3f matrixA = gm::Mat3f( 0.0f, 5.0f, 10.0f, 15.0f, 20.0f, 25.0f, 30.0f, 35.0f, 40.0f );
    gm::Mat3f matrixB = gm::Mat3f( 0.0f, 7.0f, 14.0f, 21.0f, 28.0f, 35.0f, 42.0f, 49.0f, 56.0f );
    matrixB -= matrixA;
...
{
    gm::Mat3f matrixA = gm::Mat3f( 0.0f, 10.0f, 20.0f, 30.0f, 40.0f, 50.0f, 60.0f, 70.0f, 80.0f );
    gm::Mat3f matrixB = matrixA / 5.0f;
    CHECK( matrixB == gm::Mat3f( 0.0f, 2.0f, 4.0f, 6.0f, 8.0f, 10.0f, 12.0f, 14.0f, 16.0f ) );
}
